...
export class CalendarFlightsComponent implements OnInit {
  ...
  ngOnInit() : void {
   /*  this.lowCostAll = this.sessionStorageService.retrieve('ss_lowcosto');
    ...
    this.currency = this.calendar[0].currency;
    this.calendar.forEach((element: any) => {
  ...
  validarCalendar(){
    this.zeta = document.getElementById('dia');
    this.equis = document.getElementById('aerolinea');
    this.equis.style.border = 'none';
    this.equis.style.cursor = 'pointer';
    this.equis.style.textAlign = 'center';
    this.zeta.style.cursor = 'pointer';
    this.zeta.style.border = '1px solid #9A9A9A';
    this.zeta.style.borderRadius = '13px 0px 0px 0px';
    this.zeta.style.textAlign = 'center';
  ...
  validarDia(){
    ...
    this.zeta = document.getElementById('dia');
    this.equis = document.getElementById('aerolinea');
    this.zeta.style.border = 'none';
    this.zeta.style.cursor = 'pointer';
    this.zeta.style.textAlign = 'center';
    this.equis.style.cursor = 'pointer';
    this.equis.style.border = '1px solid #9A9A9A';
    this.equis.style.borderRadius = '13px 0px 0px 0px';
    this.equis.style.textAlign = 'center';
   
  }

  searchFlight(salida: any, llegada: any){
    const Fechas = {
      Salida: salida,
      Llegada: llegada
    }
